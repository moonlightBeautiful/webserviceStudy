 ...
 * 2020-04-03T21:55:44.118+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "HelloServiceService", 
                  wsdlLocation = "http://192.168.1.33/service/helloService?wsdl",
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelloServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.1.33/service/helloService?wsdl");
        }
        WSDL_LOCATION = url;
    }
