...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://impl.webService.ims.com/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://impl.webService.ims.com/", "say");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.webService.ims.com/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.webService.ims.com/", name = "say")
