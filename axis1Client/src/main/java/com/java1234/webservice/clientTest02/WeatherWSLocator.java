 ...
 */
    ...
    public WeatherWSLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for WeatherWSSoap12
    private String WeatherWSSoap12_address = "http://www.webxml.com.cn/WebServices/WeatherWS.asmx";
    ...
    private String WeatherWSSoap12WSDDServiceName = "WeatherWSSoap12";

    public String getWeatherWSSoap12WSDDServiceName() {
        return WeatherWSSoap12WSDDServiceName;
    }

    public void setWeatherWSSoap12WSDDServiceName(String name) {
    ...
    public void setWeatherWSSoap12EndpointAddress(String address) {
        WeatherWSSoap12_address = address;
    }


    // Use to get a proxy class for WeatherWSSoap
    private String WeatherWSSoap_address = "http://www.webxml.com.cn/WebServices/WeatherWS.asmx";
    ...
    // The WSDD service name defaults to the port name.
    private String WeatherWSSoapWSDDServiceName = "WeatherWSSoap";

    public String getWeatherWSSoapWSDDServiceName() {
        return WeatherWSSoapWSDDServiceName;
    }

    public void setWeatherWSSoapWSDDServiceName(String name) {
    ...
    public void setWeatherWSSoapEndpointAddress(String address) {
