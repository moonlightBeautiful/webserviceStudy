...
public class GetSupportCityStringResponse  implements java.io.Serializable {
    private String[] getSupportCityStringResult;

    public GetSupportCityStringResponse() {
    }

    public GetSupportCityStringResponse(
           String[] getSupportCityStringResult) {
     ...
     */
    public String[] getGetSupportCityStringResult() {
        return getSupportCityStringResult;
    }
     ...
     */
    public void setGetSupportCityStringResult(String[] getSupportCityStringResult) {
        this.getSupportCityStringResult = getSupportCityStringResult;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetSupportCityStringResult() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getGetSupportCityStringResult(), i);
                if (obj != null &&
